...
| -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| ~~Full history over BLE (chunked transfer)~~ **BUILT** ([ble-gatt §5.10–§5.11](../../protocol/ble-gatt.md)) | The deferral's premise — "Wi-Fi covers the case" — was wrong: the bridge's resting state is recording unattended, and the phone that comes for that data is standing in a yard. 12 h is 23 KB, ~5 s once on connect | ~~v1.1~~ **shipped**        |
