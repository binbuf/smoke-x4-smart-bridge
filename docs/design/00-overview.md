...
receiver only shows *now*. The upstream open-source project
...
- Controlling the Billows fan (we *observe* its state; the Smoke X owns control) — and per D11, even
