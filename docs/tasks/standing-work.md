...
| 8 | *Borrow an X2* | Q2 comparison across models | opportunistic | no |
| 9 | *Borrow a Billows* | **Q3, Q5** | opportunistic | no |
...
- **When a question closes**, update [02 §2.8](../design/02-smoke-x-protocol.md)'s status column *and*
