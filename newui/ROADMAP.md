...
- [~] T01 — N0 Foundations: Flutter app skeleton, package set, lint/CI and golden harness → [tasks/N0-foundations.md](tasks/N0-foundations.md) ⟵ running
- [ ] T02 — N1 Domain: entities, units, freshness, food safety and analysis engines → [tasks/N1-domain.md](tasks/N1-domain.md)
