...
class $MarksTable extends Marks with TableInfo<$MarksTable, MarkRow> {
  ...
  static const VerificationMeta _autoAnchorMeta = const VerificationMeta(
    'autoAnchor',
  );
  @override
  late final GeneratedColumn<bool> autoAnchor = GeneratedColumn<bool>(
    'auto_anchor',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('auto_anchor')) {
      context.handle(
        _autoAnchorMeta,
        autoAnchor.isAcceptableOrUnknown(data['auto_anchor']!, _autoAnchorMeta),
      );
    }
    return context;
  }
  ...
  MarkRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MarkRow(
      ...
      autoAnchor: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}auto_anchor'],
      )!,
    );
  }
...
class MarkRow extends DataClass implements Insertable<MarkRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['auto_anchor'] = Variable<bool>(autoAnchor);
    return map;
  }
  ...
  factory MarkRow.fromJson(
    ...
    return MarkRow(
      ...
      autoAnchor: serializer.fromJson<bool>(json['autoAnchor']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'autoAnchor': serializer.toJson<bool>(autoAnchor),
    };
  }
  ...
  MarkRow copyWith({
    ...
    autoAnchor: autoAnchor ?? this.autoAnchor,
  );
  MarkRow copyWithCompanion(MarksCompanion data) {
    return MarkRow(
      ...
      autoAnchor: data.autoAnchor.present
          ? data.autoAnchor.value
          : this.autoAnchor,
    );
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, bridgeId, sessionId, t, kind, probe, text_, autoAnchor);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is MarkRow &&
          ...
          other.autoAnchor == this.autoAnchor);
}
...
class MarksCompanion extends UpdateCompanion<MarkRow> {
  ...
  const MarksCompanion({
    ...
    this.autoAnchor = const Value.absent(),
  });
  ...
  static Insertable<MarkRow> custom({
    ...
    return RawValuesInsertable({
      ...
      if (autoAnchor != null) 'auto_anchor': autoAnchor,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (autoAnchor.present) {
      map['auto_anchor'] = Variable<bool>(autoAnchor.value);
    }
    return map;
  }
...
class $CooksTable extends Cooks with TableInfo<$CooksTable, CookRow> {
  ...
  static const VerificationMeta _donenessMeta = const VerificationMeta(
    'doneness',
  );
  @override
  late final GeneratedColumn<String> doneness = GeneratedColumn<String>(
    'doneness',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> hazard = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('wholeMuscleRedMeat'),
  );
  static const VerificationMeta _safetyModeMeta = const VerificationMeta(
    'safetyMode',
  );
  @override
  late final GeneratedColumn<String> safetyMode = GeneratedColumn<String>(
    'safety_mode',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('enthusiast'),
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('doneness')) {
      context.handle(
        _donenessMeta,
        doneness.isAcceptableOrUnknown(data['doneness']!, _donenessMeta),
      );
    }
    ...
    if (data.containsKey('safety_mode')) {
      context.handle(
        _safetyModeMeta,
        safetyMode.isAcceptableOrUnknown(data['safety_mode']!, _safetyModeMeta),
      );
    }
  ...
  CookRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CookRow(
      ...
      doneness: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}doneness'],
      )!,
      hazard: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}hazard'],
      )!,
      safetyMode: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}safety_mode'],
      )!,
...
class CookRow extends DataClass implements Insertable<CookRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['doneness'] = Variable<String>(doneness);
    map['hazard'] = Variable<String>(hazard);
    map['safety_mode'] = Variable<String>(safetyMode);
  ...
  factory CookRow.fromJson(
    ...
    return CookRow(
      ...
      doneness: serializer.fromJson<String>(json['doneness']),
      hazard: serializer.fromJson<String>(json['hazard']),
      safetyMode: serializer.fromJson<String>(json['safetyMode']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'doneness': serializer.toJson<String>(doneness),
      'hazard': serializer.toJson<String>(hazard),
      'safetyMode': serializer.toJson<String>(safetyMode),
  ...
  CookRow copyWithCompanion(CooksCompanion data) {
    return CookRow(
      ...
      doneness: data.doneness.present ? data.doneness.value : this.doneness,
      hazard: data.hazard.present ? data.hazard.value : this.hazard,
      safetyMode: data.safetyMode.present
          ? data.safetyMode.value
          : this.safetyMode,
  ...
  String toString() {
    return (StringBuffer('CookRow(')
          ...
          ..write('doneness: $doneness, ')
          ..write('hazard: $hazard, ')
          ..write('safetyMode: $safetyMode, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is CookRow &&
          ...
          other.doneness == this.doneness &&
          other.hazard == this.hazard &&
          other.safetyMode == this.safetyMode &&
...
class CooksCompanion extends UpdateCompanion<CookRow> {
  ...
  final Value<String> doneness;
  final Value<String> hazard;
  final Value<String> safetyMode;
  ...
  const CooksCompanion({
    ...
    this.doneness = const Value.absent(),
    this.hazard = const Value.absent(),
    this.safetyMode = const Value.absent(),
  ...
  static Insertable<CookRow> custom({
    ...
    Expression<String>? doneness,
    Expression<String>? hazard,
    Expression<String>? safetyMode,
  ...
  CooksCompanion copyWith({
    ...
    Value<String>? doneness,
    Value<String>? hazard,
    Value<String>? safetyMode,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (doneness.present) {
      map['doneness'] = Variable<String>(doneness.value);
    }
    if (hazard.present) {
      map['hazard'] = Variable<String>(hazard.value);
    }
    if (safetyMode.present) {
      map['safety_mode'] = Variable<String>(safetyMode.value);
    }
...
class $CookProbeRolesTable extends CookProbeRoles
  ...
  static const VerificationMeta _isIntactMeta = const VerificationMeta(
    'isIntact',
  );
  @override
  late final GeneratedColumn<bool> isIntact = GeneratedColumn<bool>(
    'is_intact',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('is_intact')) {
      context.handle(
        _isIntactMeta,
        isIntact.isAcceptableOrUnknown(data['is_intact']!, _isIntactMeta),
      );
    }
    return context;
  }
  ...
  CookProbeRoleRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CookProbeRoleRow(
      ...
      isIntact: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_intact'],
      )!,
    );
  }
...
class CookProbeRoleRow extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['doneness'] = Variable<String>(doneness);
    if (!nullToAbsent || hazard != null) {
      map['hazard'] = Variable<String>(hazard);
    }
    map['is_intact'] = Variable<bool>(isIntact);
    return map;
  }
  ...
  CookProbeRolesCompanion toCompanion(bool nullToAbsent) {
    return CookProbeRolesCompanion(
      ...
      doneness: Value(doneness),
      hazard: hazard == null && nullToAbsent
          ? const Value.absent()
          : Value(hazard),
      isIntact: Value(isIntact),
    );
  }
  ...
  factory CookProbeRoleRow.fromJson(
    ...
    return CookProbeRoleRow(
      ...
      doneness: serializer.fromJson<String>(json['doneness']),
      hazard: serializer.fromJson<String?>(json['hazard']),
      isIntact: serializer.fromJson<bool>(json['isIntact']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'doneness': serializer.toJson<String>(doneness),
      'hazard': serializer.toJson<String?>(hazard),
      'isIntact': serializer.toJson<bool>(isIntact),
    };
  }
  ...
  CookProbeRoleRow copyWith({
    ...
    doneness: doneness ?? this.doneness,
    hazard: hazard.present ? hazard.value : this.hazard,
  ...
  CookProbeRoleRow copyWithCompanion(CookProbeRolesCompanion data) {
    return CookProbeRoleRow(
      ...
      doneness: data.doneness.present ? data.doneness.value : this.doneness,
      hazard: data.hazard.present ? data.hazard.value : this.hazard,
      isIntact: data.isIntact.present ? data.isIntact.value : this.isIntact,
    );
  }
...
class CookProbeRolesCompanion extends UpdateCompanion<CookProbeRoleRow> {
  ...
  const CookProbeRolesCompanion({
    ...
    this.doneness = const Value.absent(),
    this.hazard = const Value.absent(),
    this.isIntact = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<CookProbeRoleRow> custom({
    ...
    return RawValuesInsertable({
      ...
      if (doneness != null) 'doneness': doneness,
      if (hazard != null) 'hazard': hazard,
      if (isIntact != null) 'is_intact': isIntact,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isIntact.present) {
      map['is_intact'] = Variable<bool>(isIntact.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class $GapsTable extends Gaps with TableInfo<$GapsTable, GapRow> {
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {bridgeId, sessionId, fromT};
  @override
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final CookDao cookDao = CookDao(this as AppDatabase);
  late final AlarmRuleDao alarmRuleDao = AlarmRuleDao(this as AppDatabase);
...
class $$MarksTableFilterComposer extends Composer<_$AppDatabase, $MarksTable> {
  ...
  ColumnFilters<bool> get autoAnchor => $composableBuilder(
    column: $table.autoAnchor,
    builder: (column) => ColumnFilters(column),
  );
}
...
class $$MarksTableOrderingComposer
  ...
  ColumnOrderings<bool> get autoAnchor => $composableBuilder(
    column: $table.autoAnchor,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$MarksTableAnnotationComposer
  ...
  GeneratedColumn<bool> get autoAnchor => $composableBuilder(
    column: $table.autoAnchor,
    builder: (column) => column,
  );
}
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<bool> autoAnchor = const Value.absent(),
              }) => MarksCompanion(
                id: id,
                bridgeId: bridgeId,
                sessionId: sessionId,
...
class $$CooksTableFilterComposer extends Composer<_$AppDatabase, $CooksTable> {
  ...
  ColumnFilters<String> get doneness => $composableBuilder(
    column: $table.doneness,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get safetyMode => $composableBuilder(
    column: $table.safetyMode,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CooksTableOrderingComposer
  ...
  ColumnOrderings<String> get doneness => $composableBuilder(
    column: $table.doneness,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get safetyMode => $composableBuilder(
    column: $table.safetyMode,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CooksTableAnnotationComposer
  ...
  GeneratedColumn<String> get doneness =>
      $composableBuilder(column: $table.doneness, builder: (column) => column);

  GeneratedColumn<String> get hazard =>
      $composableBuilder(column: $table.hazard, builder: (column) => column);

  GeneratedColumn<String> get safetyMode => $composableBuilder(
    column: $table.safetyMode,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> presetId = const Value.absent(),
                Value<String> doneness = const Value.absent(),
                Value<String> hazard = const Value.absent(),
                Value<String> safetyMode = const Value.absent(),
                Value<int?> pitBandMinF10 = const Value.absent(),
                Value<int?> pitBandMaxF10 = const Value.absent(),
...
class $$CookProbeRolesTableFilterComposer
  ...
  ColumnFilters<bool> get isIntact => $composableBuilder(
    column: $table.isIntact,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CookProbeRolesTableOrderingComposer
  ...
  ColumnOrderings<bool> get isIntact => $composableBuilder(
    column: $table.isIntact,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CookProbeRolesTableAnnotationComposer
  ...
  GeneratedColumn<bool> get isIntact =>
      $composableBuilder(column: $table.isIntact, builder: (column) => column);
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> doneness = const Value.absent(),
                Value<String?> hazard = const Value.absent(),
                Value<bool> isIntact = const Value.absent(),
                Value<int> rowid = const Value.absent(),
...
mixin _$CookDaoMixin on DatabaseAccessor<AppDatabase> {
  $CooksTable get cooks => attachedDatabase.cooks;
  $CookProbeRolesTable get cookProbeRoles => attachedDatabase.cookProbeRoles;
  $SamplesTable get samples => attachedDatabase.samples;
  $SessionsTable get sessions => attachedDatabase.sessions;
  CookDaoManager get managers => CookDaoManager(this);
}

class CookDaoManager {
  final _$CookDaoMixin _db;
  CookDaoManager(this._db);
  $$CooksTableTableManager get cooks =>
      $$CooksTableTableManager(_db.attachedDatabase, _db.cooks);
  $$CookProbeRolesTableTableManager get cookProbeRoles =>
      $$CookProbeRolesTableTableManager(
...
mixin _$AlarmRuleDaoMixin on DatabaseAccessor<AppDatabase> {
  $AlarmRulesTable get alarmRules => attachedDatabase.alarmRules;
  AlarmRuleDaoManager get managers => AlarmRuleDaoManager(this);
}

class AlarmRuleDaoManager {
  final _$AlarmRuleDaoMixin _db;
  AlarmRuleDaoManager(this._db);
  $$AlarmRulesTableTableManager get alarmRules =>
      $$AlarmRulesTableTableManager(_db.attachedDatabase, _db.alarmRules);
}

mixin _$SyncStateDaoMixin on DatabaseAccessor<AppDatabase> {
  $SyncStatesTable get syncStates => attachedDatabase.syncStates;
  $GapsTable get gaps => attachedDatabase.gaps;
  $SamplesTable get samples => attachedDatabase.samples;
...
class SyncStateDaoManager {
  ...
  $$GapsTableTableManager get gaps =>
      $$GapsTableTableManager(_db.attachedDatabase, _db.gaps);
  $$SamplesTableTableManager get samples =>
      $$SamplesTableTableManager(_db.attachedDatabase, _db.samples);
}
