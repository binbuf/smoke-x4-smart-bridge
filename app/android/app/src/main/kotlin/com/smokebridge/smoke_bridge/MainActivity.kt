...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // A14 — the AP-routing binder. Untouched by A24.2.
        ...
        // A24.2 — the OS-settings deep-links the preflight gate needs (13
    ...
    /**
     * A24.2 — each preflight "Open … settings" button is a system Intent with
     ...
     * and the machine-backed secondary keeps a live next step.
     */
