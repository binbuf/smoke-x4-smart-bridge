...
void main() {
  testWidgets(
    'a widget throwing during build surfaces the error boundary UI',
    (tester) async {
  ...
  testWidgets(
    'a fatal zone report overlays the app with the error screen',
    (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const ErrorBoundary(
            child: Scaffold(body: Text('healthy')),
          ),
        ),
      );
